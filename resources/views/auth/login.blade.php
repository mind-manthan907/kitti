        ...
        <div class="max-w-md w-full space-y-8">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    Or
                    <a href="{{ route('registration.create') }}" class="font-medium text-golden-500 hover:text-golden-700">
            ...
            <form class="mt-8 space-y-6" action="{{ route('auth.login') }}" method="POST">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="#" class="font-medium text-golden-500 hover:text-golden-700">
                ...
                <div>
                    <button type="submit" 
                        ...
                        <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                            <i class="fas fa-sign-in-alt text-golden-800 group-hover:text-golden-900"></i>
                        </span>
                        Sign in
                    </button>
                </div>
