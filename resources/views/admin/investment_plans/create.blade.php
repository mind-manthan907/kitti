...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    ...
    <div class="px-4 sm:px-0">
        <form id="investmentPlanForm" class="space-y-8">
            @csrf
            <!-- General Settings -->
                ...
                <div class="px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="number" id="min_duration_months" name="min_duration_months" min="1" max="120" value="6"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
                        ...
                        <div>
                            ...
                            <input type="number" id="max_duration_months" name="max_duration_months" min="1" max="120" value="12"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
...
<script>
    document.getElementById("investmentPlanForm").addEventListener("submit", function(e) {
        ...
        fetch("{{ route('admin.investment-plans.store') }}", {
                method: "POST",
                headers: {
